...
<template>
	<!-- 模板要求：必须有一个根标签 -->
		<div class="au_detail">
			<div class="au_title">
				<div class="au_dt_lf">
					<div class="au_dt_tit" v-text="cname"></div>
					<div class="au_dt_stit" v-text="financing+'·'+many+'·'+tmt"></div>
				</div>
				<div class="au_dt_rg">
			...
			<div class="au_boon">
				<div class="au_b_lf">
					<div class="au_b_lf_p">
					<img src="../../assets/utimeclock.png" alt="">&nbsp;&nbsp;上午09:30-下午06:30
					</div>
					<div>
						<img src="../../assets/rili.png" alt="">双休
						<img src="../../assets/shoutixiang.png" alt="">弹性工作
					</div>
				</div>
				<div class="au_b_rg">
					更多福利<img src="../../assets/向右尖括号.png" alt="">
				</div>
			</div>
			<div class="au_boon1">
...
<script>
	...
	export default {
		...
		props:['cname','financing','tmt','many']
	 ...
	 .au_detail {
	  ...
	  flex-wrap: wrap; }
	   .au_detail .au_title {
	    ...
	    align-items: center;
	    width: 100%; }
	     .au_detail .au_title .au_dt_lf .au_dt_tit {
	      display: flex;
	      justify-content: space-between;
	      align-items: center;
	      font-size: 1.7rem; }
